...
{
    /// <summary>
    /// The C# implementation of the contract defined in Stablecoin_contract.proto that is located in the "protobuf"
    /// folder.
    /// Notice that it inherits from the protobuf generated code. 
    /// </summary>
    public class StablecoinContract : StablecoinContractContainer.StablecoinContractBase
    {
        /// <summary>
        ...
        {
            return new HelloReturn {Value = "Hello!"};
        }
    }
}